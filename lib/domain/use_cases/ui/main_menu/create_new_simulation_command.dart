...
import 'package:sj_manager/domain/use_cases/ui/simulation/jumper_reports/set_up_jumper_level_reports_command.dart';
...
import 'package:sj_manager/data/models/simulation/database/utils/default_simulation_database_creator.dart';
import 'package:sj_manager/data/models/simulation/database/utils/default_simulation_database_saver_to_file.dart';
import 'package:sj_manager/data/models/simulation/user_simulation/user_simulation_model.dart';
import 'package:sj_manager/data/models/simulation/user_simulation/user_simulations_registry_saver_to_file.dart';
...
class CreateNewSimulationCommand {
  ...
  late UserSimulationModel _userSimulation;
  ...
  Future<void> _addUserSimulationRecord() async {
    ...
    _userSimulation = UserSimulationModel(
