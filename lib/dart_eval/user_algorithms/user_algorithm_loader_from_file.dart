  ...
  Future<T> load(String source) async {
    ...
    final runtime = Runtime.ofProgram(program)
      ...
      ..registerBridgeFunc(
          ...
          $ClassificationScoreCreatingContext.$new) // TODO: Maybe without 'E'?
      ..registerBridgeFunc('package:sj_manager/bridge.dart', 'ClassificationScore<E>',
          $ClassificationScore.$new)
      ..registerBridgeFunc('package:sj_manager/bridge.dart', 'ClassificationScoreCreator',
          $ClassificationScoreCreator$bridge.$new)
      ..registerBridgeFunc(
      ...
      ..registerBridgeFunc('package:sj_manager/bridge.dart', 'Standings', $Standings.$new)
      ..registerBridgeFunc('package:sj_manager/bridge.dart', 'ValueRepo', $ValueRepo.$new)
