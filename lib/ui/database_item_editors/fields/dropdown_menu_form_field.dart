...
class DropdownMenuFormField<T> extends FormField<T> {
  DropdownMenuFormField({
    ...
    super.validator,
            ...
            builder: (FormFieldState<T> field) {
              final state = field as DropdownMenuFormFieldState<T>;
  ...
  @override
  FormFieldState<T> createState() => DropdownMenuFormFieldState<T>();
}

class DropdownMenuFormFieldState<T> extends FormFieldState<T> {
