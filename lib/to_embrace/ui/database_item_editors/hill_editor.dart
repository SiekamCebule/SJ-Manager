...
import 'package:sj_manager/to_embrace/ui/database_item_editors/fields/my_numeral_text_field.dart';
...
import 'package:sj_manager/general_ui/reusable_widgets/arrow_icon.dart';
...
import 'package:sj_manager/general_ui/reusable_widgets/database_item_images/item_image_not_found_placeholder.dart';
import 'package:sj_manager/general_ui/reusable_widgets/menu_entries/predefined_reusable_entries.dart';
          ...
          child: Column(
            ...
            children: [
                        ...
                        LayoutBuilder(
                          builder: (context, constraints) {
                            return CountriesDropdown(
                              ...
                              countries: widget.countriesRepo.getAll(),
              ...
              MyNumeralTextField(
                ...
                min: 0.0,
                max: 1000,
                //max: context.read<GameVariantEditingDefaultsRepository>().maxKAndHs,
                onHelpButtonTap: () {
              ...
              MyNumeralTextField(
                ...
                min: 0.0,
                max: 1000,
                //max: context.read<DbEditingDefaultsRepository>().maxKAndHs,
                onHelpButtonTap: () {
                  showSimpleHelpDialog(
                      context: context,
                      title: 'Punkt HS',
              ...
              MyNumeralTextField(
                ...
                max: 10,
                //max: context
                //  .read<DbEditingDefaultsRepository>()
              ...
              MyNumeralTextField(
                ...
                min: 0.0,
                max: 1000,
                // max: context.read<DbEditingDefaultsRepository>().maxHillPoints,
                maxDecimalPlaces: 2,
                onHelpButtonTap: () {
                  showSimpleHelpDialog(
                      context: context,
                    ...
                    child: MyNumeralTextField(
                      ...
                      additionalButtons: [
                        TextButton(
                          onPressed: () {
                            if (_cachedHill != null) {
                              var autoTailwind = _cachedHill!.pointsForHeadwind * 1.5;
                              //context
                              //   .read<DbEditingDefaultsRepository>()
