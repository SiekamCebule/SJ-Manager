...
import 'package:sj_manager/features/game_variants/data/data_sources/game_variant_models_data_source.dart';
...
class HardcodedGameVariantsRepository implements GameVariantsRepository {
  ...
  final GameVariantModelsDataSource dataSource;

  Map<String, GameVariant> _cache = {};

  @override
  Future<void> loadAllVariants() async {
    final models = await dataSource.getAllVariants();
