...
class SearchForTraineesJumpersDialog extends StatefulWidget {
  const SearchForTraineesJumpersDialog({
    super.key,
  ...
  @override
  State<SearchForTraineesJumpersDialog> createState() =>
      _SearchForTraineesJumpersDialogState();
}

class _SearchForTraineesJumpersDialogState extends State<SearchForTraineesJumpersDialog> {
