    ...
    return CardWithTitle(
      title: Row(
        children: [
          ...
          const Gap(5),
          CountryFlag(
            country: context.read<CountriesRepository>().byCode('ch'),
            width: 25,
          ),
          const Gap(5),
          Text(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      const Gap(5),
                      CountryFlag(
                        country: context.read<CountriesRepository>().byCode('no'),
                        height: 15,
                      ),
                    ],
                  ),
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      const Gap(5),
                      CountryFlag(
                        country: context.read<CountriesRepository>().byCode('pl'),
                        height: 15,
                      ),
                    ],
                  ),
