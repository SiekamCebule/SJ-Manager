...
class _ListView extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final teamsState = context.watch<TeamsCubit>().state as TeamsDefault;
    final teams = teamsState.countryTeams.where((countryTeam) {
      ...
      itemBuilder: (context, index) {
        return CountryTeamOverviewListTile(
          ...
          onTap: () async {
            ...
            final flagsRepo = context.read<CountryFlagsRepository>();
