...
import 'package:sj_manager/features/career_mode/subfeatures/manager_data/presentation/bloc/simulation_manager_cubit.dart';
import 'package:sj_manager/features/career_mode/subfeatures/manager_data/presentation/dialogs/manage_partnerships/show_manage_partnerships_dialog.dart';
import 'package:sj_manager/features/career_mode/subfeatures/manager_data/presentation/dialogs/search_for_charges_jumpers/show_search_for_charges_dialog.dart';
import 'package:sj_manager/features/career_mode/subfeatures/simulation_flow/presentation/bloc/simulation_flow_cubit.dart';
import 'package:sj_manager/features/career_mode/subfeatures/subteams/domain/entities/subteam.dart';
import 'package:sj_manager/features/career_mode/subfeatures/subteams/presentation/bloc/subteams_cubit.dart';
import 'package:sj_manager/features/career_mode/subfeatures/team_reports/presentation/bloc/team_reports_cubit.dart';
...
import 'package:sj_manager/features/career_mode/subfeatures/subteams/presentation/dialogs/set_up_subteams/show_subteams_setting_up_personal_coach_dialog.dart';
...
import 'package:sj_manager/features/career_mode/subfeatures/training/presentation/dialogs/set_up_trainings/show_set_up_trainings_dialog.dart';
import 'package:sj_manager/features/career_mode/subfeatures/simulation_flow/presentation/dialogs/simulation_exit_are_you_sure_dialog.dart';
import 'package:sj_manager/features/career_mode/subfeatures/subteams/presentation/dialogs/subteams_setting_up_help_dialog.dart';
import 'package:sj_manager/features/career_mode/subfeatures/training/presentation/dialogs/training_tutorial_dialog.dart';
import 'package:sj_manager/features/career_mode/subfeatures/training/presentation/dialogs/trainings_are_not_set_up_dialog.dart';
import 'package:sj_manager/features/career_mode/subfeatures/training/presentation/dialogs/trainings_setting_up_help_dialog.dart';
import 'package:sj_manager/features/career_mode/ui/pages/main_page/simulation_route_main_action_button.dart';
import 'package:sj_manager/features/career_mode/ui/reusable/jumper/jumper_simple_list_tile.dart';
import 'package:sj_manager/features/career_mode/ui/reusable/jumper/jumper_in_team_overview_card.dart';

import 'package:sj_manager/features/career_mode/subfeatures/training/presentation/widgets/jumper_training_manager_row/jumper_training_manager_row.dart';
import 'package:sj_manager/features/career_mode/ui/pages/team_page/team_overview_card_no_jumpers_info_widget.dart';
import 'package:sj_manager/features/career_mode/ui/pages/team_page/team_screen_no_jumpers_info_widget.dart';
import 'package:sj_manager/features/career_mode/ui/pages/team_page/team_screen_personal_coach_bottom_bar.dart';
import 'package:sj_manager/features/career_mode/ui/pages/team_page/team_summary_card.dart';
import 'package:sj_manager/features/career_mode/ui/pages/country_team_profile/country_team_overview_list_tile.dart';
import 'package:sj_manager/features/career_mode/ui/pages/country_team_profile/country_team_profile_widget.dart';
